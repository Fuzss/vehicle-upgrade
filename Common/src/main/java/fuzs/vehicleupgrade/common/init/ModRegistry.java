package fuzs.vehicleupgrade.common.init;
...
public class ModRegistry {
    ...
    /**
     * Blocks that can be passed through by mobs defined in {@link #TRAVERSING_MOUNTS_ENTITY_TYPE_TAG} while they are
     * ridden.
     *
     * @see ServerConfig#mountsPassThroughLeaves
     */
     ...
     *
     * @see ClientConfig#holdItemsWhileRowing
     */
     ...
     *
     * @see ServerConfig#saddledMountsDoNotWander
     */
     ...
     * @see ServerConfig#mountsPassThroughLeaves
     */
    public static final TagKey<EntityType<?>> TRAVERSING_MOUNTS_ENTITY_TYPE_TAG = TAGS.registerEntityTypeTag(
            "traversing_mounts");
    /**
     * Mobs that turn translucent (i.e. begin to fade) when a riding player looks down on them.
     *
     * @see ClientConfig#translucentMount
     */
     ...
     *
     * @see ServerConfig#sprintWhileRiding
     */
     ...
     *
     * @see ServerConfig#openMobInventoryByInteracting
     */
     ...
     *
     * @see ServerConfig#shrinkOverSizedBoatPassengers
     */
