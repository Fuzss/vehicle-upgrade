        ...
        return new RenderableComponent() {
            ...
            public void renderComponent(GuiGraphics guiGraphics, Font font, int posX, int posY) {
                if (backgroundLocation != null) {
                    guiGraphics.blitSprite(backgroundLocation, posX + iconOffsetX, posY, iconSize, iconSize);
                }
                guiGraphics.blitSprite(foregroundLocation, posX + iconOffsetX, posY, iconSize, iconSize);
            }
        };
    }
}
